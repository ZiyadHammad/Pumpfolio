...
const BodyPartCard = ({ item, bodyPart, setBodyPart }) => {
  return (
    <div 
      className={`${bodyPart === item ? 'border-[#ff2625]' : ''} bg-white w-[200px] h-[200px] border-t-4 flex flex-col justify-center items-center transform scale-100 transition duration-300 ease-in-out cursor-pointer`}
      onClick={() => {
        setBodyPart(item)
